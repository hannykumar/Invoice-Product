...
export const SHIPPED_TEMPLATES: readonly TemplateDefinition[] = [
  {
    ...
    optionalFields: [
      ...
      'footer.terms', 'footer.declaration', 'footer.computerGenerated', 'footer.eoe',
    ...
    footerNote: null,
    publishedOn: '2026-09-13' as IsoDate,
  },
  {
    id: 'bakery-warm',
    version: '1.1.0',
    ...
    optionalFields: ['seller.logo', 'seller.phone', 'line.note', 'footer.thankYou', 'totals.amountPaid', 'qr.upi'],
  ...
  },
  {
    ...
    typography: { bodyStack: DEVANAGARI_SAFE, headingStack: DEVANAGARI_SAFE, baseSizePt: 8 },
    optionalFields: ['seller.phone', 'totals.amountPaid', 'footer.thankYou', 'qr.upi'],
    lineColumns: [],
  ...
  },
  {
    ...
    typography: { bodyStack: DEVANAGARI_SAFE, headingStack: DEVANAGARI_SAFE, baseSizePt: 10 },
    optionalFields: ['seller.logo', 'seller.email', 'seller.bankDetails', 'seller.pan', 'document.dueDate', 'document.references', 'document.paymentTerms', 'line.note', 'footer.terms', 'footer.computerGenerated', 'qr.upi'],
    lineColumns: ['line.note'],
  ...
  },
  {
    ...
    optionalFields: [
      ...
      'transport.vehicleNumber', 'transport.transporter', 'transport.eWayBillNumber',
      'transport.lrNumber', 'transport.document', 'transport.destination',
      'footer.computerGenerated', 'footer.eoe', 'qr.upi',
    ],
