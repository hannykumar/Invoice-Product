...
const T = {
  ...
  // Issue #186 — the labels a printed credit or debit note needs. Hindi keeps its plain form (#139).
  creditNoteNo: w('Credit Note No.', 'Wapsi note number'),
  debitNoteNo: w('Debit Note No.', 'Note number'),
  noteDate: w('Date', 'Taarikh'),
  againstInvoice: w('Against Invoice No.', 'Kis bill par'),
  againstSupplierInvoice: w('Against Supplier Invoice No.', 'Supplier ka bill'),
  dated: w('dated', 'dinank'),
  noteReason: w('Reason', 'Wajah'),
  recipient: w('Recipient', 'Kiske naam'),
  supplierParty: w('Supplier', 'Supplier'),
  totalCredited: w('Total Credited', 'Kul wapas ki gayi rakam'),
  totalDebited: w('Total Debited', 'Kul rakam'),
  noteInWords: w('Amount (in words)', 'Shabdon mein'),
